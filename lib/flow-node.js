...
module.exports = flow = function(temporaryFolder) {
    ...
    $.post = function(req, callback) {
        ...
        //防止上传文件可能名字和大小同时重复，添加用户的_id到Identifier
        var identifier = req.user._id+"-"+cleanIdentifier(fields['flowIdentifier']);
        ...
        if (validation == 'valid') {
            ...
            fs.rename(files[$.fileParameterName].path, chunkFilename, function() {
                //console.log("----------------files[$.fileParameterName].path="+files[$.fileParameterName].path);
