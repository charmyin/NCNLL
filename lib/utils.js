...
/***Generate save or update response***/
...
/**获取TOKEN**/
exports.getTokenObject = function(){
  //获取access_token https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxb14e210fe0f465ec&secret=69d25a9d2acdeb8b1a094a477c8d9b37
  //获取ticket https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token=ACCESS_TOKEN&type=jsapi
  //获取signature
  var str = "jsapi_ticket="+ticket+"&noncestr="+asdfasd1234fwerqwer313+"&timestamp="+timestamp+"&url="+url;
  return object;
}